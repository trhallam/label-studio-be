...
#         raise ValueError(
#             "Inference class should be the subclass of "
#             + LabelStudioMLBase.__class__.__name__
#         )
...
#         if not auth or not (
#             safe_str_cmp(auth.username, BASIC_AUTH[0])
#             and safe_str_cmp(auth.password, BASIC_AUTH[1])
#         ):
#             return Response(
#                 "Unauthorized",
#                 401,
